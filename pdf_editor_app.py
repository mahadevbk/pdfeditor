   ...
   # Function to clean text for OCR output
   def clean_text(text):
       # Remove non-printable characters and invalid UTF-8 sequences
       text = re.sub(r'[^\x20-\x7E\n\r\t]', '', text)  # Keep printable ASCII, newline, carriage return, tab
